...
gallery/dialog/1.0/mask
gallery/dialog/1.0/mini
gallery/dialog/1.0/index
...
KISSY.add('gallery/dialog/1.0/mask',function(S, Node) {
    var $ = Node.all;
...
KISSY.add('gallery/dialog/1.0/mini',function(S, Node, Mask) {
    var $     = Node.all,
        $body = $('body');
...
KISSY.add('gallery/dialog/1.0/index',function(S, Dialog) {
    return Dialog;
}, {
    requires: ['./mini']
});
